...
const About = () => {
  return (
    <div>
      <h1 className="tc ma4 page-title">WHAT IS [REDACTED]?</h1>
      <div className="word-container">
        <h2 className="tc fw1 mh4">
          welcome to [REDACTED], a platform for sharing your unique pixel artworks with friends!
          each day, you’ll be given a different art prompt, and you’ll be able to create your
          artwork{" "}
